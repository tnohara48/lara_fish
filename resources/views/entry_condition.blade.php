...
<body>
    ...
    <div class="container col-9">
        <form action="{{ action('FishController@entry_action_condition') }}" method="post">
        @csrf 
            ...
            <div class="row mt-5">
                ...
                <div class="mx-auto my-5">
                    ...
                    foreach ($conditionTypes as $conditionType) {
                        ...
                        class="btn btn-lg mx-3 btn-primary submitConditionBtn">(<?= $conditionType['condition_type'] ?>)</button>
                    <?php
                    }
                    ?>
